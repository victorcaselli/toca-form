...
@Data
@Builder
public class VisitorDTORequest implements Serializable {
    ...
    public static VisitorDTORequest toDto(Visitor visitor){
        return ModelMapperUtil.map(visitor, VisitorDTORequest.class);
    }
